...
class T1F78Tag extends TTKServiceTagModel {
  T1F78Tag({required message})
      : super(
          messageType: TTKMessageType.ASCII,
          message: message,
          maxLength: null,
